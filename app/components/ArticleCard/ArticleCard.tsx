                ...
                <article className='space-y-4'>
                    <header className='capitalize'>
                        <div className='flex items-center space-x-2'>
                            ...
                            <h2 className='font-bold text-md'>{props.article.category}</h2>
                        </div>
                        <small className='mt-2 text-sm text-gray-800'>Published : <time>{new Date(props.article.pubDate).toDateString()}</time></small>
                    </header>
                    <section>
